...
class Command(BaseCommand):
    ...
    def create_trainers(self) -> None:
        ...
        trainer9 = Trainer(name="Carl",birthdate= "2002-08-24",location= "Palawan",email= "carl21@pokemon.com")
        trainer10 = Trainer(name="Uzzi" ,birthdate= "2002-08-24" ,location= "Bulacan" ,email= "kyle@pokemon.com")
    ...
    def create_collections(self) -> None:
        ...
        for pokemon in pokemons[:10]:
            collection = Collection(card=pokemon, trainer=Trainer.objects.get(name='Carl'), collection_date='2023-12-12')
            
            collection.save()
            
        for pokemon in pokemons[10:]:
            collection = Collection(card=pokemon, trainer=Trainer.objects.get(name='Jian'), collection_date='2023-12-12')
